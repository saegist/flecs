...
void Search_search() {
    ...
    ecs_id_t id;
    int32_t c = ecs_search(world, table, TagA, &id, 0);
    test_int(c, 0);
    test_uint(id, TagA);

    c = ecs_search(world, table, TagB, &id, 0);
    test_int(c, 1);
    test_uint(id, TagB);

    c = ecs_search(world, table, TagC, &id, 0);
    test_int(c, 2);
    test_uint(id, TagC);
...
void Search_search_wildcard() {
    ...
    ecs_id_t id;
    int32_t c = ecs_search(world, table, ecs_pair(Rel, EcsWildcard), &id, 0);
    test_int(c, 1);
...
void Search_search_relation_wildcard_w_offset() {
    ...
    ecs_id_t id;
    int32_t c = ecs_search(world, table, ecs_pair(EcsWildcard, ObjB), &id, 0);
    test_int(c, 2);
...
void Search_search_pair_w_any_rel() {
    ...
    ecs_id_t id;
    int32_t c = ecs_search(world, table, ecs_pair(EcsAny, ObjB), &id, 0);
    test_int(c, 2);
    test_uint(id, ecs_pair(Rel, ObjB));
...
void Search_search_pair_w_any_obj() {
    ...
    ecs_id_t id;
    int32_t c = ecs_search(world, table, ecs_pair(Rel, EcsAny), &id, 0);
    test_int(c, 1);
    test_uint(id, ecs_pair(Rel, ObjA));
